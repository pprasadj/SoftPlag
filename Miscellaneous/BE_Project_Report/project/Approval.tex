...
\large{\justify{This project report entitled }\textbf{\Large{``NAME OF PROJECT``}} by \textbf{\Large{Author Name}} is approved for the degree of \textbf{\Large{Bachelor of Engineering in Information Technology}}
%\vspace{0.25cm}
\begin{flushright}
